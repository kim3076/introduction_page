  ...
  <body>
    ...
    <ol>
      ...
      <form  action="update_process.php" method="post">
        <input type="hidden" name="old_title" value="<?=$_GET['option']?>">
        <p id="BB">
          <input type="text" value="<?=$_GET['option']?>" name="title" style="width: 500px" placeholder="title">
        </p>
        <p id="BB">

          <textarea name="description" placeholder="description" rows="15" cols="65">
            <?=file_get_contents("data/B.B.D/".$_GET['option']); ?>
          </textarea>
        </p>
